...
//              
//       $.ajax({
//            url  : '<?PHP //echo base_url()?>index.php/clientes/modificar',
//            type : 'GET',
//            data : {"id" = cliente_id},
...
<form id="formComprobante" class="form-horizontal" role="form" action="<?PHP echo base_url()?>/index.php/comprobantes/guardar_comprobante" method="post">
    <div class="row">        
        <div class="col-md-12">
        ...
        <div class="col-xs-4 col-md-4 col-lg-4">
            <!--<a onclick="javascript:window.open('<?PHP //echo base_url()?>index.php/clientes/index','','width=860,height=600,scrollbars=yes,resizable=yes')" href="#"><span class="glyphicon glyphicon-cog text-right"></span></a>-->
            <label class="control-label">Cliente:&nbsp;&nbsp;<span class="editCliente"><span class="glyphicon glyphicon-cog text-right"></span></label>
        ...
        <label class="control-label">Tipo de Cambio:</label>        
            <input type="text" class="form-control" name="tipo_de_cambio" id="tipo_de_cambio">
        </div>
        ...
        <div class="col-xs-2 col-md-2 col-lg-2">
            ...
            <div class="material-switch pull-left">
                <input id="operacion_gratuita" name="operacion_gratuita" type="checkbox" value="1">
        ...
        <div class="col-xs-2 col-md-2 col-lg-2">
            ...
            <div class="material-switch pull-left">
                <input id="operacion_cancelada" name="operacion_cancelada" type="checkbox" value="1"/>
    ...
    <div class="row" style="padding-top:20px;">                
            ...
            <div class="row" id="valida">
                <div class="col-lg-12">
                    <table id="tabla" class="table table-striped" style="display: none;">
                    <thead>
                        <tr>
                            <th>T.Servicio</th>
                            <th>Descripcion</th>
        ...
        <div class="col-xs-8 col-md-8 col-lg-8">                                                                         
                ...
                <label class=" control-label" style="margin-left:-50px">Detraccion:</label>
                    <div class="material-switch pull-left">
                        <input id="detraccion" name="detraccion" type="checkbox" value="0" onclick="javascript: return false;"  />
            ...
            <?PHP }?>    
                ...
                <div class="col-xs-2 col-md-2 col-lg-2 col-xs-offset-1">
                    ...
                    <input type="text" class="form-control" name="porcentaje_de_detraccion" id="porcentaje_de_detraccion" readonly>
                </div>
                
                <div class="col-xs-2 col-md-2 col-lg-2 col-xs-offset-1">
                    <label class="control-label">Total de Detraccion:</label>        
                    <input type="text" class="form-control" name="total_detraccion" id="total_detraccion" readonly>
                </div>
                                  ...
                                  <div class="col-xs-4 col-md-4 col-lg-4">
                                      ...
                                      <select id ="comp_adjunto" name="comp_adjunto" style="width:300px">
                                          <?PHP foreach ($comp_adjuntos as $value) { ?>
                                                <option value="<?PHP echo $value['comprobante_id']?>"><?PHP echo $value['abr'].'/ '.$value['serie'].'-'.$value['numero'];?></option>
                                          <?PHP }?>                                      
                                      </select> 
                                  ...
                                  <div class="col-xs-4 col-md-4 col-lg-4">
                                      ...
                                      <select class="form-control" id ="tipo_ncredito" name="tipo_ncredito">
                                          <?PHP foreach ($tipo_ncreditos as $value) { ?>
                                                <option value="<?PHP echo $value['id']?>"><?PHP echo $value['tipo_ncredito']?></option>
                                          <?PHP }?>
                                      </select>                                      
                                  </div>
                                   ...
                                   <div class="col-xs-4 col-md-4 col-lg-4">
                                      ...
                                      <select class="form-control" id ="tipo_ndebito" name="tipo_ndebito">
                                          <?PHP foreach ($tipo_ndebitos as $value) { ?>
                                                <option value="<?PHP echo $value['id']?>"><?PHP echo $value['tipo_ndebito']?></option>
                                          <?PHP }?>
                                      </select>                                      
                                  </div>        
                              </div>                              
    ...
    <div class="panel panel-default">
        <div class="panel panel-body">
            ...
            <div class="input-group">        
                ...
                <input type="text" id="total_gravada" name="total_gravada" class="form-control" readonly="">
            </div>
            
            <div class="input-group">        
                <span class="input-group-addon">IGV:</span>                
                <input type="text" id="total_igv" name="total_igv" class="form-control" readonly="">
            </div>
    ...
    <div class="input-group">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <input id="guardar" type="submit" class="btn btn-primary btn-lg btn-block" value="Generar Comprobante de Pago"/>
        </div>
    </div>        
            </form>
</div>   
